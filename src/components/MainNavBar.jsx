                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='hidden md:flex'>
                        <ul className='flex space-x-5 md:space-x-10 lg:space-x-20'>
                            {/* <li className='font-semibold text-lg md:text-sm'>About</li> */}
                            <li className='font-semibold text-lg md:text-sm'>Features</li>
                            <li className='font-semibold text-lg md:text-sm'>Pricing</li>
                            <li className='font-semibold text-lg md:text-sm'>Docs</li>
                            <li className='font-semibold text-lg md:text-sm'>Contact</li>
                        </ul>
                    </div>
                    ...
                    <div className='hidden md:block'>
                        <button
                            ...
                            className='bg-Btn text-white rounded-lg font-bold text-sm md:text-sm py-3 md:py-3 px-4 md:px-5 border-black hover:bg-black hover:text-white transition duration-500'>
                            Log In
                        </button>
                    </div>
                </div>
