...
const NavButton = ({ title, customFunc, icon, color, dotColor }) => (
  <TooltipComponent content={title} position='BottomCenter'>
    < button type='button' onClick={customFunc} style={{ color }}
      ...
      <span style={{ background: dotColor }} className='absolute inline-flex h-2 rounded-full w-2 right-2 top-2' />
...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative bg-black'>
